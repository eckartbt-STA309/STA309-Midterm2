...
sentiment_plot <- ggplot(album_sentiment,
                         aes(x = album_name, y = prop, fill = sentiment)) +
...
sent_vs_dance <- ggplot(song_sentiment_spotify,
                        aes(x = danceability, y = net_sentiment,
                            color = album_name)) +
...
sent_vs_energy <- ggplot(song_sentiment_spotify,
                         aes(x = energy, y = net_sentiment,
                             color = album_name)) +
  geom_point(size = 2, alpha = 0.7) +
  theme_minimal() +
  labs(
...
sent_vs_valence <- ggplot(song_sentiment_spotify,
                          aes(x = valence, y = net_sentiment,
                              color = album_name)) +
  geom_point(size = 2, alpha = 0.7) +
  theme_minimal() +
  labs(
